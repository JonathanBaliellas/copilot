# Modos de Copiloto
Copilotos podem assumir diferentes modos de resposta. Esses modos são úteis para mudar rapidamente o padrão de resposta que se deseja em determinado momento. 

## Ask
O modo **Ask** é para fazer perguntas sem alterar o código. Você pode perguntar sobre um arquivo específico, erro, função ou conceitos gerais.
...
## Plan
Usado quando pedir algo mais complexo. Neste modo o copiloto pensa e planeja antes de escrever códigos.

Ele:
- divide o problemas em etapas;
...
## Study
É focado em aprendizado ativo. Ele:
